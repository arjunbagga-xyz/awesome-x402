...
- [x402 Crypto Price Tracker](https://x402.167-172-95-184.nip.io) - Agent-payable crypto price API with 7 x402 routes on Base Sepolia: BTC/ETH prices ($0.01), per-coin prices for 12 assets ($0.02), multi-coin portfolio snapshot ($0.05), curated agent revenue opportunities ($0.03), x402 launch audit ($1.00), receipt verification ($0.05), and MCP tool calls ($0.02). Bazaar discovery extension on all 402 responses, OpenAPI 3.0.3 spec, free /demo preview, and settled payment log. $1.04+ in verified testnet revenue. [Discovery](https://x402.167-172-95-184.nip.io/.well-known/x402) | [OpenAPI](https://x402.167-172-95-184.nip.io/openapi.json) | [Manifest](https://x402.167-172-95-184.nip.io/x402.json)
